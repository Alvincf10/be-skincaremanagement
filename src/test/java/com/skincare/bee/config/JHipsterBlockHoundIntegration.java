package com.skincare.bee.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.skincare.bee.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.skincare.bee.security.DomainUserDetailsService", "createSpringSecurityUser");
