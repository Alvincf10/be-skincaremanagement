...
import com.skincare.bee.repository.ProductRepository;
import com.skincare.bee.service.dto.ProductDTO;
import com.skincare.bee.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    private static final LocalDate DEFAULT_EXPIRED_PRODUCT = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_EXPIRED_PRODUCT = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .expiredProduct(DEFAULT_EXPIRED_PRODUCT)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .expiredProduct(UPDATED_EXPIRED_PRODUCT)
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getExpiredProduct()).isEqualTo(DEFAULT_EXPIRED_PRODUCT);
    ...
    void getAllProducts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].expiredProduct")
            .value(hasItem(DEFAULT_EXPIRED_PRODUCT.toString()))
            .jsonPath("$.[*].createdAt")
    ...
    void getProduct() {
        ...
        webTestClient
            ...
            .jsonPath("$.expiredProduct")
            .value(is(DEFAULT_EXPIRED_PRODUCT.toString()))
            .jsonPath("$.createdAt")
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.productName(UPDATED_PRODUCT_NAME).expiredProduct(UPDATED_EXPIRED_PRODUCT).createdAt(UPDATED_CREATED_AT);
        ...
        assertThat(testProduct.getExpiredProduct()).isEqualTo(UPDATED_EXPIRED_PRODUCT);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productName(UPDATED_PRODUCT_NAME).expiredProduct(UPDATED_EXPIRED_PRODUCT).createdAt(UPDATED_CREATED_AT);
