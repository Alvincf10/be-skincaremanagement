...
To build the final jar and optimize the skincare application for production, run:
...
Then navigate to [http://localhost:7887](http://localhost:7887) in your browser.
